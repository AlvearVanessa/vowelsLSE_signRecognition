...
def main():
    ...
    maskClassifier = Classifier('C:/Users/master/PycharmProjects/lse_vowels_gr/Model/export_resnet.pkl', 'C:/Users/master/PycharmProjects/lse_vowels_gr/Model/labels.txt')
    while True:
        _, img = cap.read()
