...
class Classifier:
    ...
    def getPrediction(self, img, draw=True, pos=(50, 50), scale=2, color=(0, 255, 0)):
        ...
        # Expand the shape of the array, consider in the first position the amount of images in the array
...
def main():
    ...
    maskClassifier = Classifier('C:/Users/master/PycharmProjects/lse_vowels_gr/Model/keras_model', 'C:/Users/master/PycharmProjects/lse_vowels_gr/Model/labels.txt')
    while True:
        _, img = cap.read()
